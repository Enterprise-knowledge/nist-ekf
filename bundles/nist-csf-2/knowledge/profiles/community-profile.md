...
description: A profile for a sector, subsector, technology, threat type, or other shared use case.
status: active
owner:
...
A profile for a sector, subsector, technology, threat type, or other shared use case.
