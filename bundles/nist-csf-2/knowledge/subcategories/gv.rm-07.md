...
title: GV.RM-07
description: Strategic opportunities (i.e., positive risks) are characterized and are included in organizational
...
- name: Risk Management Strategy
  path: /bundles/nist-csf-2/knowledge/categories/gv.rm.md
  relation: part_of
  description: This Subcategory is part of the GV.RM Category.
nist_id: GV.RM-07
