...
title: MAP 2.2
description: Information about the AI system’s knowledge limits and how system output may be utilized and overseen
  by humans is documented. Documentation provides sufficient information to assist relevant AI actors when making
...
related:
- name: MAP-2
  path: /bundles/nist-ai-rmf-1/knowledge/categories/map-2.md
  relation: part_of
  description: This Subcategory is part of AI RMF Category MAP-2.
nist_id: MAP 2.2
ai_actors: []
topics:
- Limitations
