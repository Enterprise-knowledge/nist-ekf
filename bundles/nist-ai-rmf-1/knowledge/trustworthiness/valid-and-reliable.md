...
description: AI systems should be valid, reliable, and perform as intended under expected conditions.
status: active
owner:
...
AI systems should be valid, reliable, and perform as intended under expected conditions.
