...
title: SC-42.4 - Notice of Collection
description: 'Employ the following measures to facilitate an individual’s awareness that personally identifiable
  information is being collected by {{ insert: param, sc-42.04_odp.02 }}: {{ insert: param, sc-42.04_odp.01 }}.'
status: active
owner:
...
- name: Base control
  ...
  relation: part_of
  description: SC-42.4 - Notice of Collection is part of its parent SP 800-53 structure.
- name: SC-42 - Sensor Capability and Data
  path: /bundles/nist-sp-800-53-r5/knowledge/controls/sc/sc-42.md
  relation: enhances
  description: SC-42.4 enhances base control SC-42.
nist_id: SC-42.4
sort_id: sc-42.04
