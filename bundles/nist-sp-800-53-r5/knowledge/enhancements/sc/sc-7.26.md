...
description: 'Prohibit the direct connection of a classified national security system to an external network without
  the use of {{ insert: param, sc-07.26_odp }}.'
status: active
owner:
...
- name: Base control
  ...
  relation: part_of
  description: SC-7.26 - Classified National Security System Connections is part of its parent SP 800-53 structure.
- name: SC-7 - Boundary Protection
  path: /bundles/nist-sp-800-53-r5/knowledge/controls/sc/sc-7.md
  relation: enhances
  description: SC-7.26 enhances base control SC-7.
nist_id: SC-7.26
sort_id: sc-07.26
