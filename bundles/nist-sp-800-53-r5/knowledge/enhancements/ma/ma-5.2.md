...
title: MA-5.2 - Security Clearances for Classified Systems
description: Verify that personnel performing maintenance and diagnostic activities on a system processing, storing,
  or transmitting classified information possess security clearances and formal access approvals for at least the
  high
status: active
owner:
...
- name: Base control
  ...
  relation: part_of
  description: MA-5.2 - Security Clearances for Classified Systems is part of its parent SP 800-53 structure.
- name: MA-5 - Maintenance Personnel
  path: /bundles/nist-sp-800-53-r5/knowledge/controls/ma/ma-5.md
  relation: enhances
  description: MA-5.2 enhances base control MA-5.
nist_id: MA-5.2
sort_id: ma-05.02
...
Verify that personnel performing maintenance and diagnostic activities on a system processing, storing, or transmitting classified information possess security clearances and formal access approvals for at least the high
