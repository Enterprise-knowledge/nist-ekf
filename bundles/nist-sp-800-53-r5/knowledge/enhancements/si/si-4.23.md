...
description: 'Implement the following host-based monitoring mechanisms at {{ insert: param, si-04.23_odp.02 }}:
  {{ insert: param, si-04.23_odp.01 }}.'
status: active
owner:
...
- name: Base control
  ...
  relation: part_of
  description: SI-4.23 - Host-based Devices is part of its parent SP 800-53 structure.
- name: SI-4 - System Monitoring
  path: /bundles/nist-sp-800-53-r5/knowledge/controls/si/si-4.md
  relation: enhances
  description: SI-4.23 enhances base control SI-4.
nist_id: SI-4.23
sort_id: si-04.23
