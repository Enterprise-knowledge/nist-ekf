...
description: 'Implement changes to the current system baseline and deploy the updated baseline across the installed
  base using {{ insert: param, cm-03.03_odp }}.'
status: active
owner:
...
- name: Base control
  ...
  relation: part_of
  description: CM-3.3 - Automated Change Implementation is part of its parent SP 800-53 structure.
- name: CM-3 - Configuration Change Control
  path: /bundles/nist-sp-800-53-r5/knowledge/controls/cm/cm-3.md
  relation: enhances
  description: CM-3.3 enhances base control CM-3.
nist_id: CM-3.3
sort_id: cm-03.03
