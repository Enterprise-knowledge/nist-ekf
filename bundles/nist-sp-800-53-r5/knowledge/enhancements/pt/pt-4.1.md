...
title: PT-4.1 - Tailored Consent
description: 'Provide {{ insert: param, pt-04.01_odp }} to allow individuals to tailor processing permissions to
  selected elements of personally identifiable information.'
status: active
owner:
...
- name: Base control
  ...
  relation: part_of
  description: PT-4.1 - Tailored Consent is part of its parent SP 800-53 structure.
- name: PT-4 - Consent
  path: /bundles/nist-sp-800-53-r5/knowledge/controls/pt/pt-4.md
  relation: enhances
  description: PT-4.1 enhances base control PT-4.
nist_id: PT-4.1
sort_id: pt-04.01
