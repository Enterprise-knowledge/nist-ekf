...
title: PS-3.1 - Classified Information
description: Verify that individuals accessing a system processing, storing, or transmitting classified information
  are cleared and indoctrinated to the highest classification level of the information to which they have access
  on the
status: active
owner:
...
- name: Base control
  ...
  relation: part_of
  description: PS-3.1 - Classified Information is part of its parent SP 800-53 structure.
- name: PS-3 - Personnel Screening
  path: /bundles/nist-sp-800-53-r5/knowledge/controls/ps/ps-3.md
  relation: enhances
  description: PS-3.1 enhances base control PS-3.
nist_id: PS-3.1
sort_id: ps-03.01
...
Verify that individuals accessing a system processing, storing, or transmitting classified information are cleared and indoctrinated to the highest classification level of the information to which they have access on the
