...
- name: Base control
  ...
  relation: part_of
  description: AC-17.2 - Protection of Confidentiality and Integrity Using Encryption is part of its parent SP 800-53
    structure.
- name: AC-17 - Remote Access
  path: /bundles/nist-sp-800-53-r5/knowledge/controls/ac/ac-17.md
  relation: enhances
  description: AC-17.2 enhances base control AC-17.
nist_id: AC-17.2
sort_id: ac-17.02
