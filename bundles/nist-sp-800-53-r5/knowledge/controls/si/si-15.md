...
description: 'Validate information output from the following software programs and/or applications to ensure that
  the information is consistent with the expected content: {{ insert: param, si-15_odp }}.'
status: active
owner:
...
- name: Control family
  ...
  relation: part_of
  description: SI-15 - Information Output Filtering is part of its parent SP 800-53 structure.
nist_id: SI-15
sort_id: si-15
