...
description: 'Employ minimal functionality and information storage on the following system components: {{ insert:
  param, sc-25_odp }}.'
status: active
owner:
...
- name: Control family
  ...
  relation: part_of
  description: SC-25 - Thin Nodes is part of its parent SP 800-53 structure.
nist_id: SC-25
sort_id: sc-25
